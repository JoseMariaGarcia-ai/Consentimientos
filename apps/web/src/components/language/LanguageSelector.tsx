...
export function LanguageSelector() {
  ...
  const handleSelect = async (code: string) => {
    ...
    try {
      ...
      // Fallback already handled by i18n config
    }
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white rounded-lg px-3 py-1.5 text-sm transition-colors border border-white/20"
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-2xl border border-slate-100 z-[100] overflow-hidden">
          {/* Search */}
